...
:html_properties:
#+EXPORT_FILE_NAME: ~/share/Teaching/reveal.js-master/calendar.html
#+AUTHOR:
#+PROPERTY: HEADER-ARGS+ :eval no-export
...
| 11:00 | {{{red}}}   | {{{red}}}    | {{{red}}}    | {{{red}}} | {{{green}}} | {{{green}}} | {{{blue}}} |
| 12:00 | {{{red}}}   | {{{yellow}}} | {{{yellow}}} | {{{red}}} | {{{green}}} | {{{green}}} | {{{blue}}} |
| 13:00 | {{{red}}}   | {{{yellow}}} | {{{yellow}}} | {{{red}}} | {{{green}}} | {{{green}}} | {{{green}}} |
