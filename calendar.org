...
Never Available: @@html:<span class="block" style="background-color:red; color:red">Unavailable</span>@@

Currently Available: @@html:<span class="block" style="background-color:lime; color:lime">Available</span>@@
